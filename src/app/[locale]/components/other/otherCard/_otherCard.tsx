...
import styles from "@/app/[locale]/components/other/otherCard/otherCard.module.scss";
import WorkshopItem from "@/app/[locale]/components/other/workshopItem/workshopItem";
...
export default function OtherCard() {
  ...
  return (
    <div className={styles.otherCardGrid}>
      ...
      <div>
        <div className={"mt-4"}>
          <WorkshopItem title={t("workshop_1_title")} description={t("workshop_1_description")} type={"Talk"} />
          <WorkshopItem title={t("workshop_2_title")} description={t("workshop_2_description")} type={"Workshop"} />
          <WorkshopItem
          ...
          />
          <WorkshopItem title={t("workshop_8_title")} description={t("workshop_8_description")} type={"Workshop"} />
          <WorkshopItem
          ...
          />
          <WorkshopItem title={t("workshop_5_title")} description={t("workshop_5_description")} type={"Post"} />
          <WorkshopItem
          ...
          />
          <WorkshopItem title={t("workshop_7_title")} description={t("workshop_7_description")} type={"Talk"} />
        </div>
      </div>
    </div>
  );
